...
import Nora.modules.sql.welcome_sql as sql
import Nora
from Nora import (
    DEV_USERS,
    LOGGER,
...
from Nora.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! A member of the Famhawite Infosys just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Ka awm e!", reply_to_message_id=reply
                )
                continue
