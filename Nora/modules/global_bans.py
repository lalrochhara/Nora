...
import Nora.modules.sql.global_bans_sql as sql
from Nora.modules.sql.users_sql import get_user_com_chats
from Nora import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Nora.modules.helper_funcs.misc import send_to_list
