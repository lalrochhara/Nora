...
import Nora.modules.sql.notes_sql as sql
from Nora import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Nora.__main__ import DATA_IMPORT
from Nora.modules.helper_funcs.chat_status import user_admin
from Nora.modules.helper_funcs.alternate import typing_action

# from Nora.modules.rules import get_rules
import Nora.modules.sql.rules_sql as rulessql

# from Nora.modules.sql import warns_sql as warnssql
import Nora.modules.sql.blacklist_sql as blacklistsql
from Nora.modules.sql import disable_sql as disabledsql

# from Nora.modules.sql import cust_filters_sql as filtersql
# import Nora.modules.sql.welcome_sql as welcsql
import Nora.modules.sql.locks_sql as locksql
from Nora.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Nora{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Nora{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Nora-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Nora{}.backup".format(chat_id))  # Cleaning file
