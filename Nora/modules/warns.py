...
import telegram
from Nora import TIGERS, WOLVES, dispatcher
from Nora.modules.disable import DisableAbleCommandHandler
from Nora.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Nora.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Nora.modules.helper_funcs.string_handling import split_quotes
from Nora.modules.log_channel import loggable
from Nora.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Nora's sticker
        keyboard = None
        log_reason = (
